        ...
        <div class="content">
            <div class="login_wrap">
                ...
                <form id="frmNIDLogin" name="frmNIDLogin" target="_top" AUTOCOMPLETE="off"
                    ...
                    <input type="hidden" name="dynamicKey" id="dynamicKey" value="KEppEqFWFZdEIRKLuBFz5CO2bgjC-dD91ioJWdX24I8gq7MvXf9XAmi3_HG1ANnbJ6sKMlBYnKjhM6BqyWV32liPdCOG16gBOZTlT7cyZ-A">
